...
dfs.start_tab('uDACS');
dfs.start_col;
dfs.plot('dacsdcopt', 'label', 'uDCO2 PT', 'plots', {'dacsdcoptp','dacsdcoptt'});
dfs.plot('dacsdcoptp','label','P','vars',{'uDCO2_OE_P','uDCO2_LH_P'});
dfs.plot('dacsdcoptt','label','T','vars',{'uDCO2_OE_T','uDCO2_LH_T'});
dfs.plot('dacsdco', 'label', 'uDCO2', 'plots', {'dacsdcodac','dacsdcoais','dacsdcos'});
...
dfs.plot('dacsdcohk', 'label', 'uDCO2 HK', 'plots', {'dacsdcohkms','dacsdcohkfs','dacsdcohkouv','dacsdcohkain','dacsdcohke'});
...
dfs.plot('dacsco', 'label', 'CO2', 'plots', {'dacscop','dacscoct','dacscoft'});
dfs.plot('dacscop','label','P','vars',{'CO2_CellP'});
dfs.plot('dacscoct','label','Cell T','vars',{'CO2_Cell1T','CO2_Cell2T','CO2_Cell3T'});
dfs.plot('dacscoft','label','Flow T','vars',{'CO2_SamInT','CO2_SamOutT','CO2_RefInT','CO2_RefOutT'});
dfs.end_tab;
dfs.end_col;
