...
dfs.plot('qcli_c_stat', 'label', 'QCLI C stat', 'plots', {'qcli_c_statsn','qcli_c_stats','qcli_c_statflash','qcli_c_statmode','qcli_c_statstatus','qcli_c_statskip'});
