...
dfs.end_col;
dfs.start_col;
dfs.plot('gpsgpst', 'label', 'GPS Time', 'plots', {'gpsgpstutc','gpsgpstd'});
dfs.plot('gpsgpstutc','label','msecs UTC','vars',{'GPS_msecs_UTC'});
dfs.plot('gpsgpstd','label','Drift','vars',{'GPS_TDrift'});
dfs.plot('gpsgpsdd', 'label', 'GPS DD', 'plots', {'gpsgpsddd'});
dfs.plot('gpsgpsddd','label','Date','vars',{'GPS_DD','GPS_MM','GPS_YY'});
dfs.plot('gps_gps_lat', 'label', 'GPS Lat', 'plots', {'gps_gps_latdbl','gps_gps_latmin_em4','gps_gps_latdeg','gps_gps_latmin','gps_gps_latord'});
dfs.plot('gps_gps_latdbl','label','dbl','vars',{'GPS_Lat'});
dfs.plot('gps_gps_latmin_em4','label','min em4','vars',{'GPS_Lat_min_em4'});
dfs.plot('gps_gps_latdeg','label','deg','vars',{'GPS_Lat_deg'});
dfs.plot('gps_gps_latmin','label','min','vars',{'GPS_Lat_min'});
dfs.plot('gps_gps_latord','label','ord','vars',{'GPS_Lat_ord'});
dfs.plot('gps_gps_lon', 'label', 'GPS Lon', 'plots', {'gps_gps_londbl','gps_gps_lonmin_em4','gps_gps_londeg','gps_gps_lonmin','gps_gps_lonord'});
dfs.plot('gps_gps_londbl','label','dbl','vars',{'GPS_Lon'});
dfs.plot('gps_gps_lonmin_em4','label','min em4','vars',{'GPS_Lon_min_em4'});
dfs.plot('gps_gps_londeg','label','deg','vars',{'GPS_Lon_deg'});
dfs.plot('gps_gps_lonmin','label','min','vars',{'GPS_Lon_min'});
dfs.plot('gps_gps_lonord','label','ord','vars',{'GPS_Lon_ord'});
dfs.end_tab;
dfs.end_col;
