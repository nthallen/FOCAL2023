...
f = ne_dialg(f, 'add', 0, 1, 'gfocalcodcoptrh', 'uDCO2 PTRH' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcoptrhp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcoptrht', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcoptrhrh', 'RH' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalcodco', 'uDCO2' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcodac', 'DAC' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcoais', 'AI Stat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcos', 'Status' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalcodcohk', 'uDCO2 HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcohkms', 'M Sat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcohkfs', 'F Sat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcohkouv', 'OUV' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcohkain', 'AI N' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcodcohke', 'Errs' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalcoco', 'CO2' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcocop', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcococt', 'Cell T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcocoft', 'Flow T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalcocort', 'Rov T' );
f = ne_dialg(f, 'newcol');
...
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'newtab', 'CH4');
f = ne_dialg(f, 'add', 0, 1, 'gfocalchdchptrh', 'uDCH4 PTRH' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchptrhp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchptrht', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchptrhrh', 'RH' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalchdch', 'uDCH4' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchdac', 'DAC' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchais', 'AI Stat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchs', 'Status' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalchdchhk', 'uDCH4 HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchhkms', 'M Sat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchhkfs', 'F Sat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchhkouv', 'OUV' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchhkain', 'AI N' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchdchhke', 'Errs' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalchch', 'CH4' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchchp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchchct', 'Cell T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchchft', 'Flow T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalchchrt', 'Rov T' );
f = ne_dialg(f, 'newcol');
