...
f = ne_dialg(f, 'add', 0, 1, 'gfocalgdscoe', 'COE' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoecp', 'Cell P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoedt', 'Det Tmon' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoetemi', 'TEM Imon' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoep', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoet', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoerh', 'RH' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalgdscoehk', 'COE HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoehkaiic', 'AI I2C' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoehkn', 'Nreads' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgdscoehkc', 'Cmd' );
f = ne_dialg(f, 'newcol');
