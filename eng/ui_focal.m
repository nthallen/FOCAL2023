...
f = ne_dialg(f, 'add', 1, 0, 'pfocalcoecoehkaiic', 'AI I2C' );
...
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gfocalmoemoe', 'MOE' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmoemoecp', 'Cell P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmoemoep', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmoemoet', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmoemoerh', 'RH' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalmoemoehk', 'MOE HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmoemoehkaiic', 'AI I2C' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmoemoehkn', 'Nreads' );
f = ne_dialg(f, 'newcol');
