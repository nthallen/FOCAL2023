...
f = ne_dialg(f, 'add', 0, 1, 'gfocaldacsdcopt', 'uDCO2 PT' );
f = ne_dialg(f, 'add', 1, 0, 'pfocaldacsdcoptp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocaldacsdcoptt', 'T' );
f = ne_dialg(f, 'add', 0, 1, 'gfocaldacsdco', 'uDCO2' );
...
f = ne_dialg(f, 'add', 0, 1, 'gfocaldacsdcohk', 'uDCO2 HK' );
...
f = ne_dialg(f, 'add', 0, 1, 'gfocaldacsco', 'CO2' );
f = ne_dialg(f, 'add', 1, 0, 'pfocaldacscop', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pfocaldacscoct', 'Cell T' );
f = ne_dialg(f, 'add', 1, 0, 'pfocaldacscoft', 'Flow T' );
f = ne_dialg(f, 'newcol');
