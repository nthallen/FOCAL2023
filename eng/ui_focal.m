...
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'newtab', 'Wind');
f = ne_dialg(f, 'add', 0, 1, 'gfocalww', 'Wind' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwww', 'Wind' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwss', 'So S' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwt', 'Temp' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalwwhk', 'Wind HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwhkt', 'd Time' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwhkfi', 'File Idx' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwhkn', 'N samples' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwhkn_errors', 'N errors' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalwwhks', 'Stale' );
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'newtab', 'GPS');
f = ne_dialg(f, 'add', 0, 1, 'gfocalgpsgps', 'GPS' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpsd', 'Drift' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpsl', 'Lat' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpslon', 'Lon' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpsa', 'Alt' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpss', 'Speed' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpsc', 'Course' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalgpsgpshkn', 'GPS HK N' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshknnrmc', 'N RMC' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshknngga', 'N GGA' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshknn', 'N other' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshknn_errors', 'N errors' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshknns', 'N Sats' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalgpsgpshk', 'GPS HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshkhdop', 'HDOP' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshks', 'Status' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpshkstale', 'Stale' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalgps_gps_mlf', 'GPS mlf' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgps_gps_mlft', 'd Time' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgps_gps_mlffi', 'File Idx' );
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gfocalgpsgpsdd', 'GPS DD' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpsddd', 'Date' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalgpsgpddd', 'GPD DD' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalgpsgpddds', 'Secs' );
f = ne_dialg(f, 'newcol');
