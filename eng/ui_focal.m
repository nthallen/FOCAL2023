...
f = ne_dialg(f, 'add', 0, 1, 'gfocalmpchk', 'MPC HK' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmpchks', 'Status' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmpchkstale', 'Stale' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmpchkt', 'Torr' );
f = ne_dialg(f, 'add', 0, 1, 'gfocalmpc', 'MPC' );
f = ne_dialg(f, 'add', 1, 0, 'pfocalmpct', 'Torr' );
